const GOALS_KEY = 'visanow_uview_goals'
...
const GOAL_STEP_TEMPLATES = [
  ...
  },
  {
    ...
    title: '材料',
    tasks: [
      { id: 'prepare-materials', title: '整理基础材料', icon: 'file-text' },
      { id: 'note-plan', title: '补充办理备注', icon: 'edit-pen' },
    ],
  },
  {
    stepKey: 'book',
    title: '预约',
    tasks: [
      { id: 'schedule-time', title: '安排办理时间', icon: 'calendar' },
    ],
  },
  {
    stepKey: 'result',
    title: '结果',
    tasks: [
      { id: 'mark-complete', title: '记录本次结果', icon: 'checkmark-circle' },
    ],
  },
]
